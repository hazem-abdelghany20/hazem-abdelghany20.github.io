...
export const REFS: Record<string, RefDef> = {
  ...
  csikszentmihalyi: {
    ...
    image: {
      ...
      credit: 'Photo: Ehirsh, public domain, via <a href="https://commons.wikimedia.org/wiki/File:Mihaly_Csikszentmihalyi.jpg" rel="noopener">Wikimedia Commons</a>.',
    },
    tagline:
  ...
  frankl: {
    ...
    image: {
      src: '/refs/frankl.jpg',
      alt: 'Viktor Frankl',
      credit: 'Photo: Prof. Dr. Franz Vesely, <a href="https://creativecommons.org/licenses/by-sa/3.0/de/deed.en" rel="noopener">CC BY-SA 3.0 DE</a>, via Wikimedia Commons.',
    },
    tagline:
    ...
    start: '<em>Man\'s Search for Meaning</em> — half memoir, half clinical argument, about 150 pages.',
  },
  ...
  aurelius: {
    ...
    image: {
      ...
      credit: 'Bust in the Musée Saint-Raymond, Toulouse. Photo: Daniel Martin, <a href="https://creativecommons.org/licenses/by-sa/4.0" rel="noopener">CC BY-SA 4.0</a>, via Wikimedia Commons.',
    },
    tagline:
    ...
    start: 'Book 2 and Book 5 of the <em>Meditations</em>. Any modern translation; Hays reads best in English.',
  },
  ...
  'ibn-ataillah': {
    ...
    start: '<em>Al-Hikam</em>, with a commentary — it is compressed to the point of being cryptic alone.',
  },
  ...
  'dopamine-nation': {
    ...
    tagline: 'Pleasure and pain share a balance — so the way out of numbness is deliberate discomfort, not more pleasure.',
    body: [
  ...
  'the-comfort-crisis': {
    ...
    tagline: 'The research on what the removal of all hardship has done to us, reported from a thirty-three-day Arctic hunt.',
    body: [
  ...
  'how-emotions-are-made': {
    ...
    tagline: 'Emotions are not reactions you have. They are predictions your brain builds — from your body\'s state and your culture\'s vocabulary.',
    body: [
  ...
  'deep-work': {
    ...
    tagline: 'The ability to concentrate hard on one difficult thing is becoming rarer exactly as it becomes more valuable.',
    body: [
  ...
  'digital-minimalism': {
    ...
    tagline: 'Coined "solitude deprivation" — the modern condition of never once being alone with your own thoughts.',
    body: [
  ...
  peak: {
    ...
    tagline: 'The original research behind the 10,000-hour claim — from the man who spent his later years correcting how it was quoted.',
    body: [
  ...
  mastery: {
    ...
    tagline: 'The apprenticeship phase — the years of low pay and no recognition — is not the tax on mastery. It is the mechanism.',
    body: [
  ...
  range: {
    ...
    tagline: 'The case against early specialisation — sampling widely first produces better matches and, eventually, better performance.',
    body: [
  ...
  'thinking-in-bets': {
    ...
    tagline: 'Written by a professional poker player: judge the decision, not the result — they are different objects.',
    body: [
  ...
  'fooled-by-randomness': {
    ...
    image: {
      ...
      credit: 'Photo: Sarah Josephine Taleb, CC BY 3.0, via <a href="https://commons.wikimedia.org/wiki/File:Taleb_mug.JPG" rel="noopener">Wikimedia Commons</a>.',
    },
    tagline: 'The dead do not write memoirs, which is why every success story you read is evidence of almost nothing.',
    body: [
  ...
  'four-thousand-weeks': {
    ...
    tagline: 'A human life is about four thousand weeks. Most productivity advice is a strategy for not noticing that.',
    body: [
  ...
  'mans-search-for-meaning': {
    ...
    tagline: 'Written in nine days after three years in the camps: meaning is not found, it is answered for — through work, love, or suffering borne well.',
    body: [
  ...
  meditations: {
    ...
    tagline: 'The private notebook of a Roman emperor, arguing with himself at night, never intended to be read.',
    body: [
  ...
  'al-hikam': {
    ...
    tagline: 'About 260 aphorisms on striving, decree and self-deception — seven centuries of continuous commentary and still uncomfortable.',
    body: [
